    ...
    skills: [
      {
        ...
        tags: [
          ...
          { name: "Premiere Pro", icon: "/icons/skills/premiere.svg" },
          { name: "Figma", icon: "/icons/skills/figma.svg" },
          { name: "Branding", icon: "/icons/skills/branding.svg" },
          { name: "Print Production", icon: "/icons/skills/print-production.svg" },
          { name: "Signage", icon: "/icons/skills/signage.svg" },
          { name: "Project Management", icon: "/icons/skills/project-management.svg" },
        ],
        images: [],
      },
    ],
